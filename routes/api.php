...
//JSON ROUTES
Radjax\Route::get("/api/v1/get_all_ticket", ["get"], "App\REST\RESTController@getAllTickets", ["protected"=>false, "autoloader" => true, "save_session" => false,"before" => "App\Middleware\Before\ControllerCheck@checkRESTAuth","add_headers"=>true]);
